...
local gun = { }
gun.name = {"Surplus wand"}
gun.deck_capacity = 30
gun.actions_per_round = 1
gun.reload_time = {50,100}
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = {40,80}
gun.spread_degrees = 0
gun.speed_multiplier = 1.25
gun.mana_charge_speed = {2000,3000}
gun.mana_max = {4000,6000}
gun.actions = {"LASER","LUMINOUS_DRILL","SUMMON_ROCK","ROCKET_TIER_3","GLUE_SHOT"}
...
ComponentSetValue2( item_comp, "item_name", "Wand of Surplus" )
