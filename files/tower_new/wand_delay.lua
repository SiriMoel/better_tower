...
local gun = { }
gun.name = {"Delay wand"}
gun.deck_capacity = 15
gun.actions_per_round = 2
gun.reload_time = {20,40}
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = {10,20}
gun.spread_degrees = 0
gun.speed_multiplier = 0.7
gun.mana_charge_speed = {163,357}
gun.mana_max = {642,749}
gun.actions = {"EXPLOSION","SOILBALL","SUMMON_WANDGHOST","BLACK_HOLE_BIG","WALL_VERTICAL"}
...
ComponentSetValue2( item_comp, "item_name", "Wand of Delay" )
