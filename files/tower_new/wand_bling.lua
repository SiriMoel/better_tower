...
gun.mana_charge_speed = {100,200}
gun.mana_max = {400,600}
gun.actions = {"EXPANDING_ORB","GLOWING_BOLT","LIGHT_BULLET","SPITTER_TIER_2","LASER_EMITTER"}
...
AddGunActionPermanent( entity_id, "COLOUR_GOLD" )
...
ComponentSetValue2( item_comp, "item_name", "Wand of Bling" )
